...
function mapWorkshopItem(id, detail, hint = {}) {
  ...
  return { publishedfileid: id, title: hintTitle || `壁纸 ${id}`, preview_url: hintPreview || '', subscriptions: 0, lifetime_subscriptions: 0, views: 0, favorited: 0, lifetime_favorited: 0, file_size: 0, time_updated: 0, time_created: 0, short_description: '', tags: [], author: hintAuthor || '', creator: hintCreator || '' };
}
