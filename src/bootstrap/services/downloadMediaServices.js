  ...
  scope.getVideoController = () => {
    if (!videoController) {
      videoController = createVideoController({
        ...
        DEPOT_STREAM_CHUNK_BUFFER_BYTES: scope.DEPOT_STREAM_CHUNK_BUFFER_BYTES,
        DEPOT_STREAM_READ_THROUGH: scope.DEPOT_STREAM_READ_THROUGH,
        DEPOT_STREAM_READ_WINDOW_BYTES: scope.DEPOT_STREAM_READ_WINDOW_BYTES,
